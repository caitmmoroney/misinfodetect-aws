...
from sklearn.decomposition import FastICA#,LatentDirichletAllocation, DictionaryLearning
...
np.save('tweet_embeddings_ICA.npy', X)
...
# get results for ICA embeddings
...
LDA_full.to_csv('ICA_svm_full_results.csv')

print('Saved full results.\n')

LDA_test_mean = get_test_means(LDA_full)
LDA_test_mean.to_csv('ICA_svm_testmean_results.csv')

...
from sklearn.decomposition import NMF#, LatentDirichletAllocation, DictionaryLearning
...
np.save('tweet_embeddings_NMF.npy', X)
...
NMF_results, NMF_models = get_results(X)
NMF_results
...
# Save IVA embedding results
NMF_full = create_df(NMF_results)
NMF_full.to_csv('NMF_svm_full_results.csv')

print('Saved full results.\n')

NMF_test_mean = get_test_means(NMF_full)
NMF_test_mean.to_csv('NMF_svm_testmean_results.csv')
